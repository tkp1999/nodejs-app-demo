...
console.log(__dirname+"/images/jenkins.jpeg");
*/
app.get('/tkp1999', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Hi I am working in BGSW. Please Contact +91-9149133678,+91-7906135517 for more information or send an email to devopstrainingblr@gmail.com <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
        ...
        //res.json({'name': 'Tarun Kumar Pal'});
        res.send({
		'name': 'BGSW',
		'technology': 'DevOps',
		'contact' : '9149133678',
		'email': 'tarunkumarpal.devops@gmail.com'
	            });
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('https://www.jenkins.io/doc/pipeline/steps/');
    });
    
 
    app.listen(app.get('port'), function() {
        console.log("Node JS app is running at http://localhost:" + app.get('port') +"/tkp1999");
      })
